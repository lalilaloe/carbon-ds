export default {
    ...
    name: "text-input",
    homepage: "https://www.carbondesignsystem.com/components/text-input"
}
...
displayName:"text-input",
picture:{
src:"./pictures/text-input/text-input.png",
width:320,
height:416},
snippet:{
html:`
...
displayName:"light",
picture:{
src:"./pictures/text-input/light.png",
width:320,
height:416},
snippet:{
html:`
...
picture:{
src:"./pictures/text-input/password.png",
width:320,
height:416},
snippet:{
html:`
...
<div  data-text-input 
  ...
  <div class="bx--text-input__field-wrapper" data-invalid>
    ...
    <input data-invalid id="text-input-4" type="password"
      class="bx--text-input bx--text-input--invalid bx--password-input"
      placeholder="Placeholder text" data-toggle-password-visibility>
    <button type="button"
      class="bx--text-input--password__visibility__toggle bx--tooltip__trigger bx--tooltip--a11y bx--tooltip--bottom bx--tooltip--align-center">
      <span class="bx--assistive-text">Show password</span>
...
`}},
{
displayName:"password-light",
picture:{
src:"./pictures/text-input/password-light.png",
width:320,
height:416},
snippet:{
html:`
...
<div  data-text-input 
  ...
  <div class="bx--text-input__field-wrapper">
    <input id="text-input-3" type="password"
      class="bx--text-input bx--text-input--light bx--password-input"
      placeholder="Placeholder text" data-toggle-password-visibility>
    <button type="button"
      class="bx--text-input--password__visibility__toggle bx--tooltip__trigger bx--tooltip--a11y bx--tooltip--bottom bx--tooltip--align-center">
      <span class="bx--assistive-text">Show password</span>
...
<div  data-text-input 
  ...
  <div class="bx--text-input__field-wrapper" data-invalid>
    <svg focusable="false" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bx--text-input__invalid-icon" width="16" height="16" viewBox="0 0 16 16" aria-hidden="true"><path d="M8,1C4.2,1,1,4.2,1,8s3.2,7,7,7s7-3.1,7-7S11.9,1,8,1z M7.5,4h1v5h-1C7.5,9,7.5,4,7.5,4z M8,12.2	c-0.4,0-0.8-0.4-0.8-0.8s0.3-0.8,0.8-0.8c0.4,0,0.8,0.4,0.8,0.8S8.4,12.2,8,12.2z"></path><path d="M7.5,4h1v5h-1C7.5,9,7.5,4,7.5,4z M8,12.2c-0.4,0-0.8-0.4-0.8-0.8s0.3-0.8,0.8-0.8	c0.4,0,0.8,0.4,0.8,0.8S8.4,12.2,8,12.2z" data-icon-path="inner-path" opacity="0"></path></svg>
    <input data-invalid id="text-input-4" type="password"
      class="bx--text-input bx--text-input--invalid bx--text-input--light bx--password-input"
      placeholder="Placeholder text" data-toggle-password-visibility>
    <button type="button"
      class="bx--text-input--password__visibility__toggle bx--tooltip__trigger bx--tooltip--a11y bx--tooltip--bottom bx--tooltip--align-center">
      <span class="bx--assistive-text">Show password</span>
